/**
 * Vendored from mitsuhiko/agent-stuff (Apache-2.0), extensions/no-sleep.ts.
...
export default function noSleepExtension(pi: ExtensionAPI) {
	...
	// agent_end can be followed by retries or queued follow-ups; wait until Pi
	// confirms the whole run has settled before allowing sleep again.
